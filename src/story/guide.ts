...
export const GUIDE: GuideStep[] = [
  ...
  },
  {
    ...
    todo: ['In "The truth", write the central question and what really happened', 'Add a few clues and at least one red herring', 'Note who holds which secrets'],
  ...
  },
  {
    ...
    todo: ['Select a paragraph, then choose Improve, Make darker, More suspense or Subtler', 'Use More ▾ → "Check my prose" for a free, instant check', 'Ask for an "Editor\'s review" of a whole chapter'],
  ...
  },
  {
    ...
    todo: ['Write how the mystery resolves, and where each character ends up', 'Decide what stays ambiguous on purpose', 'Click "Check my ending" to find loose threads'],
    check: (p) => p.ending.resolution.trim().length > 20,
    ask: { action: 'endingCheck', label: 'Check my ending' },
  },
  {
    id: 'finish',
    ...
    todo: ['Set up a backup folder (Home or Settings)', 'Export a Word document (.docx) or PDF', 'Read the whole book (Write → More ▾ → Read the whole book)'],
