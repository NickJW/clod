...
export const PAGES: Record<Page, string> = {
  ...
  mystery: 'Mystery: clues and red herrings, suspects (motive, means, opportunity), the Yarn board (a cork board with red string connecting characters, clues, secrets, events and places; "Pin it all up for me" lays it out), "Connect the dots", the truth of what really happened, secrets, and who knows what.',
...
export const TOPICS: HelpTopic[] = [
  ...
  { q: 'How do I use the yarn board?', a: 'Open Mystery, then the "Yarn board" tab. Press "Pin it all up for me" to lay out your characters, clues, secrets, events and places with red string between them. Drag cards anywhere. To tie your own string, click a card\'s red pin, then the card it connects to. Click a string to label or cut it.', go: 'mystery', show: 'Yarn board', keys: 'yarn board string red conspiracy cork pin connect wall murder' },
